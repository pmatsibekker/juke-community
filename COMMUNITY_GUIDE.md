...
Put plainly: Mockito tests your code against *your assumptions* and WireMock tests it against *a stub you maintain* — Juke tests it against *what the real system actually did*, with zero mock code to write or own.
