...
| [`juke-sample-todo`](./juke-sample-todo) | REST CRUD wired through a `@Juke("juke")` DAO; covers POST / PUT / DELETE record semantics | `mvn -pl juke-samples/juke-sample-todo spring-boot:run` |
